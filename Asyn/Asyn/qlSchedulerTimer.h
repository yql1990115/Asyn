#ifndef __QLSCHEDULERTIMER_H__
#define __QLSCHEDULERTIMER_H__

#include "qlAsynHelper.h"
#include "qlWindowEngine.h"
#include <map>
#include <list>

namespace asyn {

class CqlSchedulerTimer : public ISchedulerTimer
{
public:
	CqlSchedulerTimer(const char* strName = "CqlSchedulerTimer");
	virtual ~CqlSchedulerTimer();
...
protected:
	/// 定时调度程序窗口引擎
	CqlWindowEngine<CqlSchedulerTimer> m_window;
